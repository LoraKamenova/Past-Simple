...
@Component({
  selector: 'app-all-pictures-towns-admin',
  templateUrl: './all-pictures-towns-admin.component.html',
  styleUrls: ['./all-pictures-towns-admin.component.css']
})
export class AllPicturesTownsAdminComponent implements OnInit {
