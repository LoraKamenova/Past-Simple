...
export class QuestionComponent implements OnInit, DoCheck {
  ...
  ngOnInit(): void {
    this.questions = [
      ...
      {
        question: 'През коя година е открита Втора програма на Българската телевизия?',
        options: ['1970', '1975', '1980', '1985'],
        answer: '1975'
      },
      {
        question: 'Как се казва първият български космонавт?',
        options: ['Александър Иванов', 'Георги Иванов', 'Александър Александров', 'Георги Йорданов'],
        answer: 'Георги Иванов'
      },
      {
        question: 'Кое е най-старото българско списание, излизало без прекъсване от октомври 1945 г. до ден-днешен?',
      ...
      {
        question: 'Първата петилетка в България обхваща времето:',
      ...
      {
        question: 'През коя година е първият брой на предаването "Бразди", което продължава да се излъчва и до днес?',
